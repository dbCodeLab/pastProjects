...
/*
  ...
  for (int i=0; i!=n_walls; ++i) {
    ...
    walls[i] = new Wall(i, Vector2d(x1, y1), Vector2d(x2, y2), rand() % 64 + 32, rand(), wall_tex);
...
/*  
  cout << "il bsp contiene: " << bsptree->n_nodes << " nodi" << endl;
  cout << "elaborati: " << m << " poligoni" << endl;
  cout << "renderizzati: " << n << " poligoni" << endl << endl;*/
}
...
/*      
	...
	intensity = 0;
      ...
      tex_col = static_cast<int>(woff * wall.length) % tex_width;
